...
const sendTransactionNotification = async (email, recipientName, txnDetails) => {
    const mailOptions = {
        from: `"Apex National Bank" <${process.env.FROM_EMAIL || 'noreply@antigravitybank.com'}>`,
        to: email,
        ...
        html: `
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #1e293b; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px;">
                <div style="background-color: #0f172a; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
                    <h1 style="color: #38bdf8; margin: 0; font-size: 24px;">Apex National Bank</h1>
                </div>
                <div style="padding: 20px;">
                    ...
                    <p>Regards,<br><strong>Apex National Bank Team</strong></p>
                </div>
            </div>
        `
    };
...
const sendPasswordResetEmail = async (email, resetToken) => {
    ...
    const mailOptions = {
        from: `"Apex National Bank" <${process.env.FROM_EMAIL || 'noreply@antigravitybank.com'}>`,
        to: email,
        subject: `Password Reset Request - Apex National Bank`,
        html: `
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #1e293b; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px;">
                <div style="background-color: #0f172a; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
                    <h1 style="color: #38bdf8; margin: 0; font-size: 24px;">Apex National Bank</h1>
