      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="space-y-6 lg:col-span-1">
          ...
          <div className="p-6 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl space-y-4">
            ...
            <p className="text-sm font-bold text-slate-900 dark:text-white">support@antigravitybank.com</p>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl space-y-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              Antigravity Tower, Financial District, MG Road, Bengaluru, KA 560001
            </p>
          </div>
        </div>
